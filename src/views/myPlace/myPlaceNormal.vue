      ...
      .then(res => {
        if (res.status == 0) {
          if (res.object.length !== 0) {
            this.tabPageHeight =
              this.tabPageHeight + this.adapterHeight(res.object,'');
            this.friendActivityHeight = this.tabPageHeight;
            console.log(this.friendActivityHeight);
          }
  ...
  methods: {
    ...
    share() {
      ...
      let sObj = {
        ...
        web_url:
          _this.commonUrl +
          "myyuleWeb/webShare/myPlace/index.html?iMobile=" +
            ...
            putLotteryNotice(
              ...
              .then(res => {
                ...
                if (res.status == 0) {
                  this.tabPageHeight = this.followActivityHeight;
                  if (res.object.length !== 0) {
                    console.log(this.adapterHeight(res.object,''))
                    this.tabPageHeight =
                      this.tabPageHeight + this.adapterHeight(res.object,'');
                  }
                  this.followActivityHeight = this.tabPageHeight;
